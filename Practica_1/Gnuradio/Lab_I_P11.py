...
import Lab_I_P11_epy_block_1 as epy_block_1  # embedded python block
import sip



class Lab_I_P11(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Punto_11", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Punto_11")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_I_P11")
...
def main(top_block_cls=Lab_I_P11, options=None):
