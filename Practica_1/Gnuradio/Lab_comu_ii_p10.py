...
import Lab_comu_ii_p10_epy_block_0 as epy_block_0  # embedded python block
import Lab_comu_ii_p10_epy_block_1 as epy_block_1  # embedded python block
import sip



class Lab_comu_ii_p10(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "punto_10", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto_10")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comu_ii_p10")
        ...
        self.blocks_throttle2_2 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        ...
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 0.02, 0)
        ...
        self.connect((self.blocks_throttle2_2, 0), (self.epy_block_1, 0))
        self.connect((self.blocks_throttle2_2, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.epy_block_0, 0), (self.blocks_throttle2_2, 0))
        self.connect((self.epy_block_1, 0), (self.qtgui_time_sink_x_3, 0))
...
def main(top_block_cls=Lab_comu_ii_p10, options=None):
