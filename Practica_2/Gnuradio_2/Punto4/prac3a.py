...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.h = h = np.array([0.0, 0.5, 1.0, 0.5, 0.0, -0.3, -0.6, -0.3, 0.0])
        self.Sps = Sps = len(h)
        self.Rb = Rb = 32000
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\scsan\\Documents\\UIS\\2024-2\\Comunicaciones 2\\Repositorio\\CommunicationsII_2024_2_scb\\Practica_2\\Gnuradio_2\\Punto4\\rana.jpg', True, 0, 0)
