...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "ook")
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, 'Carrier Freq. ', "counter_slider", float)
        ...
        self._fd_win = RangeWidget(self._fd_range, self.set_fd, 'Deviation Freq', "counter_slider", float)
        ...
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_ff(0.0490874)
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.epy_block_0, 1))
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.epy_block_0_0, 1))
        ...
        self.connect((self.epy_block_0_2, 0), (self.blocks_multiply_const_vxx_1_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.epy_block_0_2, 0))
